    ...
    <div class="listbox listbox-main news-box">
            <div id="slide">
              ...
              <div class="listbox listbox-main">
                <div class="listbox-title" style="background-color: #d9534f;margin-top: 40px;">
                    <h4>QUAN TRỌNG</h4>
                </div>
                <div class="listbox listbox-main faqs-box" style="padding:20px; margin-top:0px; margin-bottom: 40px; border: solid 1px #d43f3a; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
                    <center>
                ...
                <div class="listbox listbox-main faqs-box">
                    <div style="color:blue;font-size:22px;text-align:left;font-weight:bold;padding:20px; text-transform:uppercase">TH&#212;NG B&#193;O VỀ VIỆC TIẾP TỤC ĐĂNG K&#221; NỘI TR&#218; H&#200; K&#221; T&#218;C X&#193;</div><br>
